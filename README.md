...
4. 4.Run the program using build and run.
...
6.Thus the output polynomial is obtained through tis technique.
...
# OUTPUT:
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/cbaae3fc-a8e4-4c8a-a920-fbe6f3a10d51" />


# RESULT:
Thus the error detection using CRC-CCITT[16 bit] technique is implemented and the output is obtained and verified successful
